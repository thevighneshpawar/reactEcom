...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    try {
      ...
      toast.success("Order SucessFull Thank you ")
      setTimeout(() => {
  ...
  return (
    <Layout >
      <div className="h-screen bg-gray-100 pt-28 mb-[50%] " style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div key={index} className="justify-between mb-6 rounded-lg border  drop-shadow-xl bg-white p-6  sm:flex  sm:justify-start" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }}>
                  ...
                  <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                    <div className="mt-5 sm:mt-0">
                      ...
                      <h2 className="text-sm  text-gray-900" style={{ color: mode === 'dark' ? 'white' : '' }}>{item.description.substring(0, 200) + '...'}</h2>
